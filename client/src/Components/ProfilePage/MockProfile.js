...
// var jay= require("../images/crew/jay.jpg");
...
renderJayProfilePage=()=>{
  ...
  const {userProfile, userGroup} = this.state
                  ...
                  <Box colorIndex='light-2'
                        ...
                        pad='large'>
                                ...
                                <Columns size='medium'
                                      ...
                                      {userGroup.map((group)=>(
                                            <Tile>
                                                     <Link to={`/groups/${group.group_name}`} groupinfo={group.creator}><Card id='thumbnail' thumbnail={randomImage}
